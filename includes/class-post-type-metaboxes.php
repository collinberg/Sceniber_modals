 ...
 * @package Modal_Post_Type
 */
class Modal_Post_Type_Metaboxes {

	public function init() {
		add_action( 'add_meta_boxes', array( $this, 'modal_meta_boxes' ) );
		add_action( 'save_post', array( $this, 'save_meta_boxes' ),  10, 2 );
	}

	/**
	 * Register the metaboxes to be used for the Modal post type
	 *
	 * @since 0.1.0
	 */
	public function modal_meta_boxes() {
		add_meta_box(
			'profile_fields',
			'Profile Fields',
	...
	*/
	function render_meta_boxes( $post ) {
		...
		<table class="form-table">
			...
			<tr>
				<td class="location_meta_box_td" >
					<label for="profile_title"><?php _e( 'Title', 'Multi_Location_CPT' ); ?>
					</label>
				</td>
				<td colspan="4">
					<input type="text" name="profile_title" class="regular-text" value="<?php echo $title; ?>">
					<p class="description"><?php _e( 'E.g. CEO, Sales Lead, Designer', 'location' ); ?></p>
				</td>
			</tr>

			<tr>
				<td class="location_meta_box_td" >
					<label for="profile_linkedin"><i class="fa fa-linkedin"></i> <?php _e( 'LinkedIn URL', 'Multi_Location_CPT' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="location_meta_box_td" >
					<label for="profile_twitter"><i class="fa fa-twitter"></i> <?php _e( 'Twitter URL', 'Multi_Location_CPT' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="location_meta_box_td">
					<label for="profile_facebook"><i class="fa fa-facebook"></i> <?php _e( 'Facebook URL', 'Multi_Location_CPTw' ); ?>
					</label>
				</td>
				<td colspan="4">
